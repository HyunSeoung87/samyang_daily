...
echo "> $JAR_PATH 배포" #3
nohup java -jar /home/ubuntu/app/build/libs/samyang_daily-0.0.1-SNAPSHOT.jar --spring.config.location=file:/home/ubuntu/properties/application.yml > /home/ubuntu/nohup.out &
